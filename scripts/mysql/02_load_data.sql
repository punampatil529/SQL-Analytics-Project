...
INSERT INTO Sales (CustomerID, ProductID, ProductName, Category, Quantity, UnitPrice, OrderDate, SalespersonID)
VALUES 
    (5, 106, 'Monitor', 'Electronics', 1, 329.99, '2024-03-01', 202),
    (6, 108, 'Headphones', 'Electronics', 2, 149.99, '2024-03-03', 205),
    (7, 101, 'Laptop Pro', 'Electronics', 1, 1299.99, '2024-03-05', 201),
    (8, 103, 'Office Chair', 'Furniture', 1, 249.99, '2024-03-08', 203),
    (9, 110, 'Tablet', 'Electronics', 1, 399.99, '2024-03-10', 204),
    (10, 109, 'Standing Desk', 'Furniture', 1, 599.99, '2024-03-12', 202),
    (1, 107, 'Webcam', 'Electronics', 1, 89.99, '2024-03-15', 205),
    (2, 105, 'Desk Lamp', 'Furniture', 1, 45.00, '2024-03-18', 201),
    (3, 111, 'Printer', 'Electronics', 1, 199.99, '2024-03-20', 203),
    (4, 102, 'Wireless Mouse', 'Electronics', 2, 29.99, '2024-03-22', 204);
...
SELECT 'MySQL sample data loaded successfully!' as Status;
